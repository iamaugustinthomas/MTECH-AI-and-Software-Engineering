...
\title{\textbf{\LARGE Descriptive Statistics}\\ \large Mathematics for Computing}
...
\vspace{0.5em}
\noindent\textbf{Imagine: The Roll Call}\\
...
\vspace{0.5em}
\noindent\textbf{Working Example: Edge Device Inference Time}\\
...
\vspace{0.5em}
\noindent\textbf{Imagine: The Seesaw vs. The Middle Child}\\
...
\vspace{0.5em}
\noindent\textbf{Imagine: The Archer's Target}\\
...
\vspace{0.5em}
\noindent\textbf{Imagine: The Statistical Sandwich}\\
...
\vspace{0.5em}
\noindent\textbf{Imagine: The City Map}\\
...
\vspace{0.5em}
\noindent\textbf{Imagine: The Playground Slide}\\
...
\vspace{0.5em}
\noindent\textbf{Imagine: The Eiffel Tower vs. Table Mountain}\\
